...
So I look forward in time with stopping me is having everything ordered but I don't think we need that. We don't need to tease the jungle for anything it'll just work or just testing out the features right now. So let's save what we have as is. And then release just try it do that
